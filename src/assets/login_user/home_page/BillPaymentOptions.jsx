...
const paymentOptions = [
  ...
  },
  {
    ...
    to: "/bill-payments/electricity-bill",
  },
  {
    src: water_bill,
    alt: "Water Bill",
    label: "Water Bill",
    to: "/bill-payments/water-bill",
  },
  {
    src: gas_bill,
    alt: "Gas Bill",
    label: "Gas Bill",
    to: "/bill-payments/gas-bill",
  },
  {
    src: fastag,
    alt: "Fastag",
    label: "Fastag",
    to: "/bill-payments/fastag",
  },
  {
    src: insurance_payment,
    alt: "Insurance Payment",
    label: "Insurance Payment",
    to: "/bill-payments/insurance-payment",
  },
  {
    src: credit_card_bill,
    alt: "Credit Card Bill",
    label: "Credit Card Bill",
    to: "/bill-payments/credit-card-bill",
  },
  {
    src: loan_repayment,
    alt: "Loan Repayment",
    label: "Loan Repayment",
    to: "/bill-payments/loan-repayment",
  },
];
