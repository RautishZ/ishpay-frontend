      ...
      <div className="px-4 text-gray-800">
        <div className="sm:max-w-5xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-base font-medium sm:text-lg mb-4 text-black">
              Join today for financial freedom.
            </p>
            <form
              onSubmit={handleSubmit}
              className="max-w-md mx-auto flex flex-col items-center sm:flex-row sm:items-center gap-3"
            >
              <input
                type="email"
              ...
              <button
                type="submit"
                className="bg-ishprimary text-white whitespace-nowrap px-6 py-3 rounded-lg hover:bg-ishprimary-600 focus:outline-none focus:bg-opacity-80"
              >
                Get Started
              </button>
            </form>
